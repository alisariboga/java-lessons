...
public class Arrays01 {
    public static void main(String[] args) {
        ...
        //What ud I look for non-existing element?
        //It will return negative number and the number will be the ORDER
        System.out.println(Arrays.binarySearch(num,4));//-2 (imagine where would 4 be)
        System.out.println(Arrays.binarySearch(num,10));//-4

        int num3[] ={3,8,12,8,7};
        System.out.println(Arrays.binarySearch(num3,8));
